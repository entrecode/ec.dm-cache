...
class Cache {
  constructor(eventEmitter, cacheSize, timeToLive, redisConfig = {}) {
    ...
    this[entryCacheRedisSymbol] = redisConfig.active ? cacheManager.caching(cacheOptionsRedis) : undefined;
    ...
    this[modelCacheRedisSymbol] = redisConfig.active ? cacheManager.caching(cacheOptionsRedis) : undefined;
